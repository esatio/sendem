...
public class FontManager extends Drawable {
    ...
    public FontManager(int icon, int sizeDpi, int color,
    ...
    public static class FontManagerBuilder {
        ...
        public FontManagerBuilder(Context context, int icon) {
            this.context = context;
            this.icon = icon;
        }
        ...
        public FontManager build() {
            return new FontManager(icon, sizeDpi, color, antiAliased, fakeBold,
